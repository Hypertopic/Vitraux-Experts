...
Fonctionalité : Consulter les vitraux indéterminés
Que sont des Vitraux indéterminés ?
Ce sont des vitraux regardés par des "experts" mais qui ne sont  toujours déterminé malgré leur passage (pas d'informations proposées sur ce vitrail)
