...
Quand Pierre clique sur un smiley "content" ou un "pouce"
Alors le commentaire recoit une nouvelle réaction qui s'affiche sous le commentaire
Et Pierre est invité à motiver sa réactive via un nouveau commentaire
...
Quand Pierre clique sur un smiley "pas d'accord" 
